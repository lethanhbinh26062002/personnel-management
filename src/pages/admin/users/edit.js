...
import { get, update } from "../../../api/personnel";
        ...
        <div class="min-h-full">
            ...
            <main>
                <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input value="${data.tel}" type="number" id="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="floating_phone" id="floating_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <img src="${data.img}" alt="" id="img" class="w-60">
